...
export type PaymentStatus = "idle" | "pending" | "completed" | "failed" | "cancelled" | string;
...
export interface StripePayPacket {
    amount: number;
    currency?: string;
    description?: string;
}
export type ApplePayPayPacket = StripePayPacket;
export interface StripePaymentIntentResponse {
    provider: string;
    flow: "card" | "apple_pay" | string;
    status: string;
    amount: number;
    currency: string;
...
export type VippsUrlOpener = (redirectUrl: string) => Promise<string | null | void> | string | null | void;
