...
export function ApplePayButton(props) {
    ...
    return (_jsx("button", { type: "button", onClick: handleClick, onPointerDown: () => setIsPressed(true), onPointerUp: () => setIsPressed(false), onPointerCancel: () => setIsPressed(false), onPointerLeave: () => setIsPressed(false), onKeyDown: () => setIsPressed(true), onKeyUp: () => setIsPressed(false), style: {
            display: "block",
            width: "100%",
...
//# sourceMappingURL=ApplePayButton.web.js.map